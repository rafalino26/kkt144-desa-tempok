    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-xl font-semibold text-ink dark:text-ink">Tambah Berita Baru</h3>
          <button
            onClick={onClose}
            disabled={isPending}
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-md border border-gray-300 px-3 py-2
                         ...
                         dark:bg-elev dark:border-border dark:text-ink dark:placeholder:text-ink/40
