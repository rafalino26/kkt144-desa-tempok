      ...
      <section className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-sm text-gray-600 leading-relaxed max-w-xl">
              Desa Tempok berada di wilayah dataran tinggi Minahasa, Kecamatan Tompaso. Berikut informasi geografi terkait.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="rounded-xl bg-white p-6 shadow-sm border border-black/5 text-sm text-gray-700 leading-relaxed space-y-4">
            ...
            {/* Add New Fields Here */}
            <div>
              <h3 className="text-base font-semibold text-ink">Informasi Tambahan</h3>
              <ul className="mt-2 text-sm text-gray-700 space-y-1">
                <li>
